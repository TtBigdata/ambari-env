...
# init env
source /scripts/system/init/kylin10-arm/init_env.sh

source /scripts/system/init/kylin10-arm/init_openssl.sh
...
#处理r环境
#source /scripts/system/init/kylin10-arm/setup_r_env.sh

#处理其他安装
source /scripts/system/init/kylin10-arm/setup_build_env.sh

#处理虚拟环境
source /scripts/system/init/kylin10-arm/setup_virtual_env.sh
